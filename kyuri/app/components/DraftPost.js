  ...
  return (
    ...
    <View style={styles.container}>
        ...
        <View style={styles.buttonWrapper}>
                <Pressable style={styles.makePostBttn} onPress={() => {addPost("@TaheeShahee", postTitle, postText, postType, "22","tom", "Novice", "tom","Tom S.","Review","Tips",false); navigation.navigate('Profile')}}>
